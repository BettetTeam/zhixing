...
$(function () {
     ...
     * 导航模态框
     * */
    $.fn.modal && $('#nav-modal').length && $('#nav-modal').modal({show: false, backdrop: false});
    /*
     * 搜索模态框
     * */
    // +function ($) {
    //     var searchModal = $('#search-modal');
    //     $.fn.modal && searchModal.length && searchModal.modal();
    // }(jQuery);
    /*
     * 二维码弹框
     * */
    +function ($) {
        ...
        //$.fn.modal&&wechatModal.length &&wechatModal.modal({show: true, backdrop: false});
        //默认显示
    ...
    * 搜索弹框
    * */
    $('.pg-header .search-btn').on('click',function () {
        $('.search-fixed').toggleClass('show');
    });
    /*
     *导航搜索
     * */
    $('.search-fixed').on('click.cancel',".cancel-btn",function (e) {
    ...
    $("#keyword-input").on('keypress',function(e) {
        ...
        if(keycode=='13') {
            ...
            if ($.trim(searchName) == "") {
                ...
                window.location.href="shangjunjie.cn/search.html?word=" + searchName;
            }
        }
    });
    // $('#search-modal').on('click.search',".cancel-btn",function (e) {
